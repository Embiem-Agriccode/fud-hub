  ...
  return (
    <div className="reveal glass-card rounded-2xl p-6 sm:p-8" style={{ marginBottom: "2.5rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 6, marginBottom: "1.75rem" }}>
        <button type="button" onClick={() => fileInputRef.current?.click()} style={{ padding: "0.7rem 1.1rem", borderRadius: 12, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.04)", color: "oklch(0.9 0.01 180)", fontSize: "0.85rem", fontWeight: 600, cursor: "pointer" }}>
          {imagePreview ? "🖼️ Change image" : "🖼️ Attach image"}
        </button>
