...
const BUSINESSES: Business[] = [
  {
    id: "1", name: "Timas Delight", category: "Uni Eats", initials: "TD",
    ...
    whatsapp: "2347026356625", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/temaslogo.jpg", image: "/temas1.jpg",
    images: ["/temas1.jpg", "/temas2.jpg", "/temas3.jpg", "/temas4.jpg", "/temas5.jpg"],
    verified: true,
  },
  {
    id: "2", name: "Shop with Lola", category: "Campus Drip", initials: "SL",
    ...
    whatsapp: "2347046998187", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/lolalogo.jpg", image: "/lola1.jpg",
    images: ["/lola1.jpg", "/lola2.jpg", "/lola3.jpg"],
    verified: true, deal: true,
  },
  {
    id: "3", name: "Shaffy's Treats", category: "Uni Eats", initials: "ST",
    ...
    whatsapp: "2348026498451", accent: "from-amber-300/30 to-emerald-400/20",
    logo: "/shaffyslogo.jpg", image: "/shaffys1.jpg",
    images: ["/shaffys1.jpg", "/shaffys2.jpg", "/shaffys3.jpg", "/shaffys4.jpg"],
    verified: true, deal: true,
  },
  {
    id: "4", name: "Everything Mata", category: "Campus Drip", initials: "EM",
    ...
    whatsapp: "2349139294346", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/matalogo.jpg", image: "/mata1.jpg",
    images: ["/mata1.jpg", "/mata2.jpg"],
    verified: true, deal: true,
  },
  {
    id: "5", name: "Anointed Accessories", category: "Tech Plug", initials: "AA",
    description: "Phones and accessories at student-friendly prices. Quality devices, fast delivery on campus.",
    tags: ["Phones", "Accessories", "Gadgets", "Charger", "Earpiece"],
    whatsapp: "2349129929484", accent: "from-cyan-400/25 to-emerald-400/15",
    logo: "/aalogo.jpg", image: "/aa1.jpg",
    images: ["/aa1.jpg", "/aa2.jpg", "/aa3.jpg", "/aa4.jpg"],
    verified: true,
  },
  {
    id: "6", name: "MBM Gadget", category: "Tech Plug", initials: "MG",
    description: "Trusted campus plug for laptops and phones. UK-used and brand new devices with verified specs.",
    tags: ["Laptops", "Phones", "UK-Used", "Samsung", "iPhone"],
    whatsapp: "2348084737552", accent: "from-emerald-400/30 to-cyan-400/10",
    logo: "/mbmlogo.jpg", image: "/mbm1.jpg",
    images: ["/mbm1.jpg", "/mbm2.jpg", "/mbm3.jpg"],
    verified: true, deal: true,
  },
  {
    id: "7", name: "10 Digit Integrated Service", category: "Uni Eats", initials: "DIS",
    ...
    whatsapp: "2347031955575", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/10 logo.jpg", image: "/10 1.jpg",
    images: ["/10 1.jpg", "/10 2.jpg", "/10 3.jpg"],
    verified: true, deal: true,
  },
  {
    id: "8", name: "Dizzorh.inc", category: "Home & Life", initials: "DI",
    description: "Handmade epoxy resin art - custom coasters, Home Decor.",
    tags: ["ResinArt", "Home Decor", "Vases", "Coasters", "Handmade"],
    whatsapp: "2347069421830", accent: "from-cyan-400/25 to-emerald-400/15",
    logo: "/dizzorhlogo.jpg", image: "/dizzorh2.jpg",
    images: ["/dizzorh2.jpg", "/dizzorh3.jpg", "/dizzorh4.jpg"],
    verified: true, deal: true,
  },
  {
    id: "9", name: "Bel's Closet", category: "Campus Drip", initials: "BC",
    ...
    whatsapp: "2348137595905", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/bellogo.jpg", image: "/bel1.jpg",
    images: ["/bel1.jpg", "/bel7.jpeg", "/bel3.jpg", "/bel6.jpeg", "/bel2.jpg", "/bel4.jpg", "/bel5.jpeg", "/bel10.jpeg"],
    verified: true,
  },
  {
    id: "10", name: "Pretty Knot", category: "Home & Life", initials: "PK",
    ...
    whatsapp: "2349115015516", accent: "from-amber-300/30 to-emerald-400/20",
    logo: "/amakalogo.jpeg", image: "/amaka1.jpeg",
    images: ["/amaka1.jpeg", "/amaka2.jpeg", "/amaka3.jpeg", "/amaka4.jpeg", "/amaka5.jpeg"],
    deal: true,
  },
  {
    id: "11", name: "NANZZ_LUXURY", category: "Campus Drip", initials: "NL",
    ...
    whatsapp: "2349020376049", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/nanzzlogo.jpeg", image: "/nanzz2.jpeg",
    images: ["/nanzz3.jpeg", "/nanzz.jpeg", "/nanzz2.jpeg", "/nanzz1.jpeg"],
    deal: true,
  },
  {
    id: "12", name: "KHADI BRAINDS & MORE", category: "Campus Drip", initials: "KB",
    ...
    whatsapp: "2347073447864", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/khadilogo.jpeg", image: "/khadi1.jpeg",
    images: ["/khadi1.jpeg", "/khadi12.jpeg", "/khadi4.jpeg", "/khadi11.jpeg", "/khadi6.jpeg", "/khadi9.jpeg"],
  },
  {
    id: "13", name: "A.L.M OTAKU WEARS", category: "Campus Drip", initials: "AO",
    ...
    whatsapp: "2348054982024", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/zakilogo.jpeg", image: "/zaki1.jpeg",
  ...
  {
    id: "14", name: "DRIP WITH KEL", category: "Campus Drip", initials: "DK",
    ...
    whatsapp: "2349122765942", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/kellogo.jpeg", image: "/kel1.jpeg",
    images: ["/kel1.jpeg", "/kel2.jpeg", "/kel3.jpeg", "/kel4.jpeg"],
    deal: true,
  },
  {
    id: "15", name: "MATASHI", category: "Campus Drip", initials: "MT",
    ...
    whatsapp: "2348029943729", accent: "from-cyan-400/25 to-emerald-400/15",
    logo: "/matashilogo.jpeg", image: "/matashi2.jpg",
    images: ["/matashi3.jpg", "/matashi4.jpg", "/matashi5.jpg", "/matashi6.jpg"],
  },
  {
    id: "16", name: "Glow City", category: "Campus Drip", initials: "GC",
    ...
    whatsapp: "2349012146029", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/glowlogo.jpg", image: "/glow1.jpg",
    images: ["/glow2.jpg", "/glow3.jpg", "/glow4.jpg", "/glow5.jpg"],
  },
  {
    id: "17", name: "Syms Souvenirs", category: "Home & Life", initials: "SS",
    ...
    whatsapp: "2347061147976", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/symslogo.jpg", image: "/syms1.jpg",
    images: ["/syms1.jpg", "/syms3.jpg", "/syms2.jpg", "/syms4.jpg"],
  },
  {
    id: "18", name: "HAZO's Collection", category: "Campus Drip", initials: "HZ",
    ...
    whatsapp: "2349060932856", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/hazologo.jpeg", image: "/hazo1.jpeg",
    images: ["/hazo1.jpeg", "/hazo2.jpeg", "/hazo3.jpeg", "/hazo4.jpeg"],
  },
  {
    id: "19", name: "BKD Art & General Printing", category: "Print & Copy", initials: "BKD",
    ...
    whatsapp: "2348162831389", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/bkdlogo.jpg", image: "/bkdshop.jpg",
    images: ["/bkdshop.jpg"], verified: true,
  },
  {
    id: "20", name: "Alaminu Bookshop", category: "Print & Copy", initials: "AB",
    ...
    whatsapp: "2347067434367", accent: "from-rose-300/20 to-emerald-400/15",
    image: "/alaminu1.jpg",
  ...
  {
    id: "21", name: "Ibro Print", category: "Print & Copy", initials: "IP",
    ...
    whatsapp: "2348137917452", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/ibrologo.jpg", image: "/ibroshop.jpg",
    images: ["/ibroshop.jpg"], verified: true, deal: true,
  },
  {
    id: "22", name: "Yusuf Dankuda Communication", category: "Tech Plug", initials: "YDC",
    ...
    whatsapp: "2347038177322", accent: "from-emerald-400/30 to-cyan-400/10",
    image: "/yusufdankuda.jpg",
    images: ["/yusufdankuda.jpg", "/yusufdankuda1.jpg", "/yusufdankuda2.jpg", "/yusufdankuda3.jpg"],
    verified: true,
  },
  {
    id: "23", name: "Dedon Photo Studio", category: "Print & Copy", initials: "DS",
    ...
    whatsapp: "2348062661141", accent: "from-orange-300/25 to-emerald-400/15",
    image: "/dedonshop.jpg", images: ["/dedonshop.jpg"],
  },
  {
    id: "24", name: "Taves Kitchen", category: "Uni Eats", initials: "TK",
    ...
    whatsapp: "2348064420724", accent: "from-cyan-400/25 to-emerald-400/15",
    logo: "/taweslogo.jpg", image: "/tawes1.jpg",
    images: ["/tawes1.jpg", "/tawes2.jpg", "/tawes3.jpg", "/tawes4.jpg", "/tawes5.jpg"],
  },
  {
    id: "25", name: "High Speed Enterprises", category: "Print & Copy", initials: "HS",
    ...
    whatsapp: "2349121131739", accent: "from-cyan-400/25 to-emerald-400/15",
    image: "/highspeedshop.jpg", images: ["/highspeedshop.jpg"], verified: true,
  },
  {
    id: "26", name: "Dynamic Laundry Service", category: "Laundry", initials: "DL",
    ...
    whatsapp: "2348121697125", accent: "from-pink-400/20 to-emerald-400/20",
    image: "/dynamic1.jpg",
    images: ["/dynamic1.jpg", "/dynamic2.jpg", "/dynamic3.jpg", "/dynamic4.jpg"],
  },
  {
    id: "27", name: "Fresh Garri", category: "Uni Eats", initials: "FG",
    description: "Premium Ijebu Garri available in Dutse. Crunchy, smooth, no stone.",
    tags: ["Garri", "Ijebu Garri", "Food", "Delivery", "Snacks"],
    whatsapp: "2348100511947", accent: "from-orange-300/25 to-emerald-400/15",
    image: "/freshgarri.jpg", images: ["/freshgarri.jpg"], deal: true,
  },
  {
    id: "28", name: "Hauwerh's Delicacy", category: "Uni Eats", initials: "HD",
    ...
    whatsapp: "2348029213590", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/hauwherlogo.jpg", image: "/hauwher1.jpg",
    images: ["/hauwher1.jpg", "/hauwher2.jpg", "/hauwher3.jpg"],
  },
  {
    id: "29", name: "BURSTING FLAVORS", category: "Uni Eats", initials: "BF",
    ...
    whatsapp: "2349160658322", accent: "from-cyan-400/25 to-emerald-400/15",
    image: "/burstinglogo.jpeg", images: ["/burstinglogo.jpeg"],
  },
  {
    id: "30", name: "feyy's iStore", category: "Tech Plug", initials: "FI",
    ...
    whatsapp: "2348091060095", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/feyyslogo.jpeg", image: "/feyys1.jpeg",
    images: ["/feyys1.jpeg", "/feyys2.jpeg", "/feyys4.jpeg"],
    deal: true,
  },
  {
    id: "31", name: "Marvie's Collection", category: "Campus Drip", initials: "MC",
    ...
    whatsapp: "2349067563686", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/marvieslogo.jpeg", image: "/marvies1.jpeg",
    images: ["/marvies1.jpeg", "/marvies2.jpeg", "/marvies3.jpeg", "/marvies4.jpeg"],
  },
  {
    id: "32", name: "Zee Arewa Treats & Treasures", category: "Uni Eats", initials: "ZT",
    ...
    whatsapp: "2349071340953", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/zee10.jpeg", image: "/zee11.jpeg",
    images: ["/zee11.jpeg", "/zee12.jpeg", "/zee13.jpeg", "/zee14.jpeg", "/zee15.jpeg", "/zee1.jpeg", "/zee2.jpeg", "/zee3.jpeg"],
  },
  {
    id: "33", name: "CJ's Cut ✂️", category: "Fresh Cuts", initials: "CC",
    ...
    whatsapp: "2348028246860", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/cjlogo.jpeg", image: "/cj1.jpeg", images: ["/cj1.jpeg"],
  },
  {
    id: "34", name: "Skay Production", category: "Print & Copy", initials: "SP",
    ...
    whatsapp: "2348039859215", accent: "from-rose-300/20 to-emerald-400/15",
    image: "/skaylogo.jpeg", images: ["/skaylogo.jpeg"],
  },
  {
    id: "35", name: "Sharp Cut Barber 💈", category: "Fresh Cuts", initials: "SB",
    ...
    whatsapp: "2349137817122", accent: "from-rose-300/20 to-emerald-400/15",
    image: "/sharp1.jpg", images: ["/sharp1.jpg", "/sharp2.jpg"], deal: true,
  },
  {
    id: "36", name: "Jossy's Empire", category: "Campus Drip", initials: "JE",
    ...
    whatsapp: "2349127151817", accent: "from-rose-300/20 to-emerald-400/15",
    logo: "/jossylogo.jpeg", image: "/jossy1.jpeg",
    images: ["/jossy1.jpeg", "/jossy2.jpeg", "/jossy3.jpeg", "/jossy4.jpeg"],
  },
  {
    id: "37", name: "Jenny Girly Essentials", category: "Campus Drip", initials: "JG",
    ...
    whatsapp: "2348073567336", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/jennygirl4.jpeg", image: "/jennygirl1.jpeg",
    images: ["/jennygirl1.jpeg", "/jennygirl3.jpeg", "/jennygirl2.jpeg"],
  },
  {
    id: "38", name: "AY Tech", category: "Print & Copy", initials: "AY",
    ...
    whatsapp: "2349037636389", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/alameenyahyalogo.jpeg", image: "/alameenyahya1.jpeg",
    images: ["/alameenyahya1.jpeg"],
  },
  {
    id: "39", name: "Isha", category: "Uni Eats", initials: "I",
    ...
    whatsapp: "2348121131015", accent: "from-pink-400/20 to-emerald-400/20",
    logo: "/aishalogo.jpeg", image: "/aisha1.jpeg",
  ...
  {
    id: "40", name: "Habbie Fit", category: "Campus Drip", initials: "HF",
    ...
    whatsapp: "2348061949293", accent: "from-orange-300/25 to-emerald-400/15",
    logo: "/habbielogo.jpeg", image: "/habbie1.jpeg",
